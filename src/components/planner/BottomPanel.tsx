...
import { Bell, Settings, MessageCircle, Clock, ChevronUp, ChevronDown } from "lucide-react";
...
export function BottomPanel({ events }: BottomPanelProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 border-t border-border bg-surface shadow-panel z-50 transition-all duration-300">
      {/* Dash Bar - Always Visible */}
